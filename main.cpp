...
static void HideWindowDecorations(HWND hwnd) {
    ...
    // force the window to refresh and apply style changes
...
void StartWindowDrag(HWND hwnd) {
    ReleaseCapture(); // Release current mouse capture
    SendMessage(hwnd, WM_NCLBUTTONDOWN, HTCAPTION, 0); // Simulate click on title bar
}
...
int WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    int winWidth = (int)(WINDOW_WIDTH * main_scale);
    int winHeight = (int)(WINDOW_HEIGHT * main_scale);
